...
const char KEY_W = 0x57;		// key W
const char KEY_S = 0x53;		// key S
const char KEY_A = 0x41;		// key A
const char KEY_D = 0x44;		// key D
const char KEY_F = 0x46;		// key F
const char KEY_M = 0x4D;		// key M
const char KEY_Q = 0x51;		// key Q
const char KEY_ESC = 27;		// key ESC
const char KEY_SPACE = 0x20;	// key space
const char KEY_TAB = 0x09;		// key tab
const char KEY_F1 = 0x70;		// key F1
const char KEY_F2 = 0x71;		// key F2
const char KEY_F3 = 0x72;		// key F3
const char KEY_F4 = 0x73;		// key F4
const char KEY_F5 = 0x74;		// key F5
const char KEY_F6 = 0x75;		// key F6
const char KEY_F7 = 0x76;		// key F7
const char KEY_F8 = 0x77;		// key F8
const char KEY_F9 = 0x78;		// key F9
const char KEY_F10 = 0x79;		// key F10
const char KEY_F11 = 0x7A;		// key F11
const char KEY_ENTER = 0xD;		// key Enter
...
class CInteger {
public:
	CInteger(int=3);			// default 5 digits
