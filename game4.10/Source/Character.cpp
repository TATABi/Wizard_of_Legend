...
namespace game_framework {
	...
	void Character::LoadBitmap()
	{
		...
		int m13[15] = { CHARACTER_SKILL_SHOCK_NOVA_01, CHARACTER_SKILL_SHOCK_NOVA_02, CHARACTER_SKILL_SHOCK_NOVA_03, CHARACTER_SKILL_SHOCK_NOVA_04, CHARACTER_SKILL_SHOCK_NOVA_05,
					    CHARACTER_SKILL_SHOCK_NOVA_06, CHARACTER_SKILL_SHOCK_NOVA_07, CHARACTER_SKILL_SHOCK_NOVA_08, CHARACTER_SKILL_SHOCK_NOVA_09, CHARACTER_SKILL_SHOCK_NOVA_10,
					    CHARACTER_SKILL_SHOCK_NOVA_11, CHARACTER_SKILL_SHOCK_NOVA_12, CHARACTER_SKILL_SHOCK_NOVA_13, CHARACTER_SKILL_SHOCK_NOVA_14, CHARACTER_SKILL_SHOCK_NOVA_15 };
		for (int i = 0; i < 15; i++)
		...
		int m15[15] = { CHARACTER_SKILL_SHOCK_NOVA_01, CHARACTER_SKILL_SHOCK_NOVA_02, CHARACTER_SKILL_SHOCK_NOVA_03, CHARACTER_SKILL_SHOCK_NOVA_04, CHARACTER_SKILL_SHOCK_NOVA_05,
						CHARACTER_SKILL_SHOCK_NOVA_06, CHARACTER_SKILL_SHOCK_NOVA_07, CHARACTER_SKILL_SHOCK_NOVA_08, CHARACTER_SKILL_SHOCK_NOVA_09, CHARACTER_SKILL_SHOCK_NOVA_10,
						CHARACTER_SKILL_SHOCK_NOVA_11, CHARACTER_SKILL_SHOCK_NOVA_12, CHARACTER_SKILL_SHOCK_NOVA_13, CHARACTER_SKILL_SHOCK_NOVA_14, CHARACTER_SKILL_SHOCK_NOVA_15 };
		for (int i = 0; i < 15; i++)
	...
	void Character::OnMove(GameMap *map)
	{
		if (_isUsingSkill)
		{
			...
			{
			case 1:
				_ani_useSkill_1.OnMove();
				break;
			case 2:
				_ani_useSkill_2.OnMove();
				break;
			case 3:
				_ani_useSkill_3.OnMove();
				break;
			}
			*/
